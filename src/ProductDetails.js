...
const ProductDetails = () => {
  ...
  const fieldValues = Object.keys(product.variations[0].attributes).map(
    (field) => (
      <tr>
        <td className={classes.Label}>{field}</td>
        <td className={classes.Value}>
          {product.variations[0].attributes[field]}
        </td>
      </tr>
    )
  );
  ...
  const fieldChoices = [...fieldValueMap.keys()].map((key) => {
    return (
    ...
    <div className={classes.ProductDetails}>
      <table className={classes.Table}>
        ...
        <tr>
          ...
          >{`Rs. ${product.variations[0].price}`}</td>
        </tr>
        <tr>
          <td className={classes.Label}>Quantity</td>
          <td className={classes.Value}>
            {product.variations[0].quantityAvailable}
          </td>
        </tr>
        <tr>
